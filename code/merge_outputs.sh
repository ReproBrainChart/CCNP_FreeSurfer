#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/RBC/freesurfer_stats/CCNP/fs-tabulate/output_ria#76b9b53e-1ea6-465c-97c0-5c518c0e83fb
cd /cbica/projects/RBC/freesurfer_stats/CCNP/fs-tabulate
